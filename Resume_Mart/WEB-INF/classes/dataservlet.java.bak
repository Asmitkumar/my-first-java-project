...
HttpSession ss=request.getSession();
		String e=(String)ctx.getAttribute("username");
		String ex=(String)ss.getAttribute("username");
		 
		System.out.println("session value:=="+ex+"application value="+e);
	    ...
	    /*  String fileName = (String) request.getParameter("file");
	      ...
	      if (fileName == null || fileName.equals(""))
			 ...
			 try
			 {
				...
				pst=con.prepareStatement("select * from  resume where  name=?");
				pst.setString(1,e);
              rs=pst.executeQuery();
			  if(rs.next())
				 {
